...
//        if grayBuffer == nil {
//            grayBuffer = UnsafeMutablePointer<CVPixelBuffer?>.allocate(capacity: MemoryLayout<CVPixelBuffer?>.size) as! CVPixelBuffer
//        }
//        CVPixelBufferCreate(kCFAllocatorDefault, 480, 640, kCVPixelFormatType_32BGRA, nil, &grayBuffer)
...
//        var newGrayPixelBuffer: CVPixelBuffer?
////        CVReturn status = CVPixelBufferCreate(kCFAllocatorDefault, imageSize.width,
////                                              imageSize.height, kCVPixelFormatType_32ARGB, (__bridge CFDictionaryRef) options,
////                                              &pxbuffer);
//        guard let grayPixelBuffer = newGrayPixelBuffer else {
//            print("Allocation failure: Could not get pixel buffer from pool (\(self.description))")
//            return nil
//        }
